...
<template>
    <AppLayout title="Dashboard">
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 d-flex flex-column align-items-center gap-4">
                <!-- <div class="p-4 bg-white overflow-hidden shadow-xl sm:rounded-lg d-flex flex-column align-items-center gap-4"> -->

                    <div class="w-50 shadow px-3 py-4 mb-5 bg-body-tertiary rounded d-flex justify-content-between align-items-center">
                        <div>
                    ...
                    <div class="w-50 shadow px-3 py-4 mb-5 bg-body-tertiary rounded d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title">Total Entradas</h4>
                            <p class="card-text">{{ totalEntradas }}</p>
                        </div>
                    ...
                    <div class="w-50 shadow px-3 py-4 bg-body-tertiary rounded d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title">Total Salidas</h4>
                            <p class="card-text">{{ totalSalidas }}</p>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-database-fill-dash" viewBox="0 0 16 16">
